...
Själva artikeln helt deskriptiv. Alla formler etc i appendix. Känns lite underligt då man läser om ngt utan att riktigt veta vad det är.

Presenterar för4delningafunktionen för $R^2$ enl [@Fisher1928] på ett överskådligt sätt. Undersök ifall detta är vadf vi implementerade i `dr2`-funktionen (som jag tycks ha missat att checka in på GH). Tycker mig känns igen strukturen men är inte helt säker!

Artikeln känns på det hela taget lite oklar och tror i övrigt inte vi behöver tillmäta fen alltför stort intresse (inledningen är dock åedagogiskt skriven).
